...
`,
  ...
  { label: "Lab name", key: "labname", pattern: "[-a-z0-9]{3,}", hint: "Lab name should include only lowercase letters a-z, 0-9, or dash.", field: "textfield" },
  { label: "Name and Surname", key: "name", pattern: "{3,}", field: "textfield" },
  { label: "Department", key: "department", pattern: "{3,}", field: "textfield" },
  { label: "Faculty", key: "faculty",pattern: "{3,}", field: "textfield" },
  { label: "Institution", key: "institution", pattern: "{3,}", field: "textfield" },
