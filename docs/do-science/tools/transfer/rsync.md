...
This error typically happens if you did not complete the onboarding guides and you need to go back to step [3.5 SSH Configuration - Final steps](/do-science/lab/#_3-5-final-steps).
