...
var PDFViewerApplication = {
  ...
  open: function(params) {
    ...
    // var url = params.url;
    var pdfAsDataUri = sessionStorage.getItem('pdfBase64');
    var pdfAsArray = convertDataURIToBinary(pdfAsDataUri);
    var self = this;
    this.setTitleUsingUrl(pdfAsArray);
  ...
  setTitleUsingUrl: function pdfViewSetTitleUsingUrl(data) {
    // this.url = url;
    this.data = data;
    // var title = pdfjsLib.getFilenameFromUrl(url) || url;
    var title = 'agreement.pdf';
    try {
