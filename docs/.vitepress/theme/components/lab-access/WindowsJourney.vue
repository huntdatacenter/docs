...
const entryIpUrl = computed(() => {
  return props.ipAddress ? props.ipAddress.replace(".", "%2E") : ""
})
      ...
      <v-expansion-panels v-model="mainExpansionPanel" elevation="0">
        ...
        >
          ...
          <v-expansion-panel-text id="vpn-config" class="mt-2">
            ...
            <!-- VPN Dialog content would go here - truncated for space -->
            <!-- The full dialog structure would be similar but with Vuetify 3 syntax -->
        ...
        <v-expansion-panel
          :disabled="
            !filterGuidesByType || ['new_user', 'new_computer', 'new_lab', 'lab_migration'].includes(filterGuidesByType)
              ? false
              : true
          "
        >
        ...
        <!-- TODO - Additional expansion panels would follow the same pattern -->
        <!-- Truncated for space, but each would be converted similarly -->
              ...
              <v-card elevation="0">
                ...
                <v-card-text class="pa-0">
                  <v-stepper v-model="workbenchStepper" orientation="vertical">
                    <v-stepper-header>
                      <v-stepper-item :complete="workbenchStepper > 1" step="1" title="Checks" />
                      <v-divider />
                      <v-stepper-item :complete="workbenchStepper > 2" step="2" title="Install your certificates" />
                      <v-divider />
                      <v-stepper-item :complete="workbenchStepper > 3" step="3" title="Login to Workbench" />
                      <v-divider />
                      <v-stepper-item step="?" title="Troubleshooting" />
                    </v-stepper-header>
                    ...
                    <v-stepper-window>
                      ...
                      <v-stepper-window-item value="2">
                        <v-card class="mb-8 pr-4" elevation="0">
                          <v-card-text>
                            Let's install the certificates that are required to allow traffic with HUNT Workbench that
                            is located in your lab.
                            <br /><br />
                            <ol>
                              <li>
                                Open your <code>.p12 certificate</code> that you downloaded from FileSender. Make sure
                                the store location is set to <code>Current User</code> and click <code>Next</code>:
                                <br />
                                <img
                                  class="pa-2"
                                  alt="1_cert_p12"
                              ...
                              <li>
                                ...
                                <i>Automatically select the certificate store based on the type of certificate</i>.
                      ...
                      <v-stepper-window-item value="3">
                        <v-card class="mb-8 pr-16" elevation="0">
                          <v-card-text>
                            ...
                            <v-alert type="info" variant="tonal" border="start" elevation="2">
                              We recommend to use
                        ...
                        <v-btn
                          color="success"
                          class="mx-2 mb-1"
                          @click="workbenchDialog = false; workbenchStepper = 1"
                          >Finish</v-btn
                        >
                            ...
                            <details class="my-2">
                              ...
                              <div class="pl-4 pr-16 py-2">
                                ...
                                <ol>
                                  ...
                                  <br />
                                  <li>
                                    If you have not yet installed a fresh client certificate on this computer, review
                                    the section <strong>Install your certificates</strong> above. Start by click on blue
