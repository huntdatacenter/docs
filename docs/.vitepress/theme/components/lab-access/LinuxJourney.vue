      ...
      <v-expansion-panels v-model="mainExpansionPanel" elevation="0">
          ...
          <v-expansion-panel-text id="fetch-secrets" class="mt-2">
            ...
            <ol>
              ...
              <li>
                ...
                <a href="/do-science/tools/transfer/7z/#detail-2-ubuntu" target="_blank"
                  ...
                  <v-stepper-vertical v-model="vpnStepper" class="mt-16" hide-actions>
                    ...
                    >
                      <v-card class="mb-8 pr-4" elevation="0">
                        ...
                        Install the openvpn and network-manager-openvpn-gnome packages from the standard
                        repositories:<br />
                        ...
                        <details>
                          ...
                          <ul>
                            ...
                            <li>
                              Add the
                              <a href="https://community.openvpn.net/openvpn/wiki/OpenvpnSoftwareRepos" target="_blank"
                                >OpenVPN community repository</a
                              >
                              and install the <code>openvpn</code> package.
                            </li>
                            <li>
                              Download the latest
                              <a href="https://openvpn.net/index.php/open-source/downloads.html" target="_blank"
                                >source tarball</a
                              >
                              from OpenVPN and install.
                            </li>
                          </ul>
                          <br />
                    ...
                    >
                      <v-card class="mb-8 pr-4" elevation="0">
                        <ol>
                          ...
                          <li>
                            Select the OpenVPN profile named <code>{{ username }}.ovpn</code> that you collected in Step
                            1.
                          </li>
                          ...
                          <li>
                            ...
                            <code>Ask for this password every time</code>.
                          </li>
                          <li>
                            Enter the <i>Private Key Password</i> with the <code>VPN passphrase</code> sent to you from
                            HUNT over Signal.
                          </li>
                    ...
                    >
                      <v-card class="mb-8 pr-4" elevation="0">
                        <ol>
                          ...
                          <li>
                            In the Authenticate VPN window, enter the <code>verification code</code> from TOTP (Google
                            Authenticator) app into the Password field.
                          </li>
                    ...
                    >
                      <v-card class="mb-8 pr-4" elevation="0">
                        <v-alert border="start" border-color="success" elevation="2">
                          ...
                          <hr class="mt-1 mb-2" />
                          If you received the notification that
                          <code>VPN connection has been successfully established</code>,<br />
                    ...
                    >
                      <v-card class="mb-8 pr-4" elevation="0">
                        ...
                        <br />
                        <h3 id="unable-to-apply-changes">
                          <a href="#unable-to-apply-changes" class="header-anchor">#</a> Unable to apply changes
                        </h3>
                        <div>
                          If you are unable to click <i>Apply</i> after your changes, try to re-enter your
                          <code>Private Key Password</code> using your VPN passphrase that you received in Signal
                          message.
                        </div>
                        ...
                        <div>
                          ...
                          using: <code>sudo apt install nmap</code> and then run:
                        </div>
                        <CopyTextField
        ...
        >
          ...
          <v-expansion-panel-text id="passwordless-access" ref="passwordlessAccessRef" class="mt-2">
            <v-row>
              <v-col cols="12">
                {{ getNextItem(passLessId, true) }} Open new Terminal window (<code>CTRL + ALT + T</code>) and generate
                ssh key. If command reports that id_rsa key already exists, to avoid overwriting your existing keys
                press <code>n</code> and skip to next step.
                <CopyTextField
        ...
        >
          ...
          <v-expansion-panel-text id="ssh-config" ref="sshConfigRef" class="mt-2">
            ...
            <v-col cols="12">
              {{ getNextItem(sshConfId, true) }} Open new Terminal window (<code>CTRL + ALT + T</code>) and assure SSH
        ...
        >
          ...
          <v-expansion-panel-text id="hosts-file" ref="hostsFileRef" class="mt-2">
            ...
            <v-col cols="12">
              ...
              text editor. You will be asked for administrator password of your local computer. <br /><br />
                      ...
                      <v-card class="mb-8 pr-4" elevation="0">
                        ...
                        <ol>
                          ...
                          <li>
                            ...
                            <a href="chrome://settings/certificates" target="_blank">chrome://settings/certificates</a>
                            and navigate to section <code>Authorities</code>.
                          </li>
                          <li>
                            Click the <strong>Import</strong> button on the right side of the screen to import
                            <code>hctsca1.crt</code> certificate file.
                          </li>
                          <li>
                          ...
                          <li>
                            Within
                            <a href="chrome://settings/certificates" target="_blank">chrome://settings/certificates</a>
                            navigate to section <code>Your certificates</code> and click the
                            <strong>Import</strong> button on the right side of the screen.
                          </li>
                          <li>
                            Browse and select your
                            <code style="font-weight: bold">{{ labName }}-{{ username }}.p12</code> file that you
                            downloaded to your local computer, and enter the <strong>TLS passphrase</strong> that we
                            sent you on Signal.
                          </li>
