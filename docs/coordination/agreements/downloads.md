...
- **Data size**: This is the size in gigabytes of the storage area in the kista. You can for example use [NCDU](/hunt-lab/technical-tools/ncdu/) to estimate the size of your data.
