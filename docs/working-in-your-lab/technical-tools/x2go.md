...
permalink: /hunt-lab/technical-tools/x2go
sidebarDepth: 1
...
Follow the setups outlines in the **`Configure the X2Go client for home machines`** for further setup, including **`In the connection tab`**, **`In the media tab`**, **`connecting to the X2Go server`** and **`Connect to other software`**: [Start here](/hunt-lab/technical-tools/x2go/#configure-the-x2go-client-for-home-machines).
...
If this is causing too many problems, alternatives to X2GO like [MobaXterm](/hunt-lab/technical-tools/mobaxterm/) can be considered.
